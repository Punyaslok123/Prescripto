  ...
  return (
    ...
    >
      ...
      <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
        ...
        <div className='flex flex-col md:flex-row items items-center gap-3 text-white text-sm font-light'>
        ...
        {/* if we click this button then it should scroll the webpage to menu , which is find by speciality */}
